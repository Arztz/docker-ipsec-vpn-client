...
SED_TEMPLATE="s/VPN_SERVER_IP/${VPN_SERVER_IP}/;s/VPN_GROUP_NAME/${VPN_GROUP_NAME}/;s/VPN_IPSEC_PSK/${VPN_IPSEC_PSK}/;s/VPN_USER/${VPN_USER}/;s/VPN_PASSWORD/${VPN_PASSWORD}/;s/DEFAULT_GW/${DEFAULT_GW}/;s/LOCAL_PORT/${LOCAL_PORT}/"
